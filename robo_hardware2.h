...
//  boolean lerSensorFimDeCurso();
  ...
  RGB getRGBDireito(); 	//realiza a leitura do sensor de cor direito e retorna uma estrutura RGB. Ver cor.h
	...
	inline const bool fimDeCursoPressionado1(){return digitalRead(FIM_DE_CURSO1) == LOW;}
       inline const bool fimDeCursoPressionado2(){return digitalRead(FIM_DE_CURSO2) == LOW;}
